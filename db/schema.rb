...
ActiveRecord::Schema[7.0].define(version: 2022_08_09_195754) do
  ...
  create_table "identity_identity", id: :bigint, default: nil, force: :cascade do |t|
    t.string "aadhar", limit: 12, null: false
    t.string "pancard", limit: 10, null: false
    t.integer "owner_id", null: false
    t.index ["owner_id"], name: "identity_identity_owner_id_key", unique: true
  end
  ...
  add_foreign_key "identity_identity", "auth_user", column: "owner_id", name: "identity_identity_owner_id_63019cfb_fk_auth_user_id", deferrable: :deferred
end
